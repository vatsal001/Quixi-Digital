                                    ...
                                    <ul className="nav navbar-nav mb-2 mb-lg-0">
                                        <li className="menu-item-has-children">
                                            ...
                                            <ul className="sub-menu">
                                                <li><Link onClick={ClickHandler} to="/home">Creative Agency</Link></li>
                                                <li><Link onClick={ClickHandler} to="/home-2">Business Agency</Link></li>
                                                <li><Link onClick={ClickHandler} to="/home-3">Digital Agency</Link></li>
                                            </ul>
                                        </li>
                                        <li><Link onClick={ClickHandler} to="/about">About </Link>
                                        </li>
                                        <li className="menu-item-has-children">
                                            <Link onClick={ClickHandler} to="#">Services </Link>
                                            <ul className="sub-menu">
                                                <li><Link onClick={ClickHandler} to="/service">Service</Link></li>
                                                <li><Link onClick={ClickHandler} to="/service-single/Email-Marketing12">Service Single</Link></li>
                                            </ul>
                                        </li>
                                        <li className="menu-item-has-children">
                                            ...
                                            <ul className="sub-menu">
                                                ...
                                                <li><Link onClick={ClickHandler} to="/project-single/Jack-Rose">Portfolio Single</Link></li>
                                            </ul>
                                        </li>
                                        <li className="menu-item-has-children">
                                            ...
                                            <ul className="sub-menu">
                                                ...
                                                <li><Link onClick={ClickHandler} to="/blog-left-sidebar">Blog left sidebar</Link>
                                                </li>
                                                <li><Link onClick={ClickHandler} to="/blog-fullwidth">Blog fullwidth</Link></li>
                                                <li><Link onClick={ClickHandler} to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1">Blog details </Link>
                                                </li>
                                            </ul>
                                        </li>
                                        <li className="menu-item-has-children">
                            ...
                            <div className="col-lg-5 col-md-4 col-2">
                                <div className="header-right">
                                    ...
                                    <div className="close-form">
                                        <Link onClick={ClickHandler} className="theme-btn" to="/contact"><span> Contact
                                            us</span>
