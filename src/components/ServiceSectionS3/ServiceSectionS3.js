    ...
    return (
        <section className="service-section-s3 section-padding">
            <div className="container">
                <div className="title scroll-text-animation" data-animation="fade_from_buttom">
                ...
                <div className="row scroll-text-animation" data-animation="fade_from_buttom">
                    {Services.slice(11, 14).map((serve, item) => (
                        <div className="col-lg-4 col-md-6 col-12" key={item}>
                            <div className="service-card-s3">
                                ...
                                <h2><Link onClick={ClickHandler} to={`/service-single/${serve.slug}`}>{serve.title}</Link></h2>
