    ...
    return (
        <section className="hero-section-s2">
                ...
                <div className="hero-wrap">
                    <div className="title">
                        <div className="splittext-line">
                            <h2 className="normal scroll-text-animation" data-animation="fade_from_bottom">NEXT-LEVEL
                                DIGITAL AGENCY</h2>
                            <div className="bottom-image scroll-text-animation" data-animation="fade_from_bottom">
                                <div className="image">
                                    <img src={Mid} alt="" />
                                </div>
                                <Link onClick={ClickHandler} to="/about"><i className="ti-arrow-top-right"></i></Link>
                            </div>
            ...
            <ul className="hero-social">
                ...
                <li><Link onClick={ClickHandler} to="#" className="active">tw</Link></li>
                <li><Link onClick={ClickHandler} to="#">in</Link></li>
                <li><Link onClick={ClickHandler} to="#">yt</Link></li>
            </ul>
        </section>
    );
};
