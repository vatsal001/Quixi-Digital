            ...
            <div className="container">
                <div className="title">
                    ...
                    <div className="title-bottom scroll-text-animation" data-animation="fade_from_right">
                        ...
                        <Link onClick={ClickHandler} to="/team"> <span className="rolling-text">More Team Members</span>
                ...
                <div className="team-btn scroll-text-animation" data-animation="fade_from_right">
                    <Link onClick={ClickHandler} to="/contact" className="theme-btn"> <span className="rolling-text">Contact us</span><i
