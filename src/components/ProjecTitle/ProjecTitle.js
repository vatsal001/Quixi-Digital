    ...
    return (
        <section className={"" + props.hclass}>
            <div className="container">
                <div className="title">
                    <h2 className="scroll-text-animation" data-animation="fade_from_bottom"><span>Want To</span> Elevate <span>Your Business?</span></h2>
                    <div className="circel-shape">
                        <img src={shape} alt="" />
                    </div>
                    <div className="fade_bottom">
                        <Link onClick={ClickHandler} to="/contact"> <span className="rolling-text">Let’s Work Together</span>
