                    ...
                    <div className="col col-lg-10 col-12 offset-lg-1">
                        <div className="post format-standard-image">
                            ...
                            <div className="entry-meta">
                                <ul>
                                    <li><i className="fi flaticon-calendar"></i><Link onClick={ClickHandler} to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1">02 Apr 2024</Link>
                                    </li>
                                    <li><i className="fi flaticon-comments"></i> <Link onClick={ClickHandler} to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1">Coments (03)</Link>
                                    </li>
                                    <li><i className="fi flaticon-clock"></i><Link onClick={ClickHandler} to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1">3 min Read</Link></li>
                                </ul>
                            </div>
                                ...
                                <div className="col-lg-6 col-12">
                                    <div className="tag-share clearfix">
                                        <div className="tag">
                                            <span>Tag: </span>
                                            <ul>
                                                <li><Link onClick={ClickHandler} to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1">Business</Link></li>
                                                <li><Link onClick={ClickHandler} to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1">Design</Link></li>
                                                <li><Link onClick={ClickHandler} to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1">apps</Link></li>
                                                <li><Link onClick={ClickHandler} to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1">data</Link></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-lg-6 col-12">
                                    <div className="tag-share-s2 clearfix">
                                        <div className="tag">
                                            <span>Share: </span>
                                            <ul>
                                                <li><Link onClick={ClickHandler} to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1"><i className="ti-facebook"></i></Link>
                                                </li>
                                                ...
                                                <li><Link onClick={ClickHandler} to="/blog-single/How-To-Teach-Kids-Ramadan-Isn’t-About-Food1"><i className="ti-tumblr-alt"></i></Link></li>
