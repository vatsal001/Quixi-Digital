        ...
        <div className="row">
          ...
          <div className="col-lg-3 col-md-6 col-12 fade_bottom">
            <div className="item btn-wrapper btn-move">
              <h2>
                <span>
                  <CountUp end={402} enableScrollSpy />
                </span>
                +
              </h2>
