                        ...
                        <div className="project-top-info">
                            <div className="row align-items-center">
                                <div className="col-lg-8 col-12">
                                    ...
                                    <Link onClick={ClickHandler} to="/service" className="theme-btn"> <span className="rolling-text">All
                                        Services</span></Link>
                                </div>
                                <div className="col-lg-4 col-12">
                                    <div className="project-info">
                                        <ul>
                                            ...
                                            <li>
                                                <h3>Website</h3>
                                                <span> <Link onClick={ClickHandler} to="#">wiatech.com</Link></span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div className="info-content">
                                <div className="info-item">
                                    <div className="left">
                                        <h2 className="poort-text poort-in-right">Interesting facts in
                                            Development</h2>
                                    </div>
                                    <div className="right">
                                ...
                                <div className="info-item">
                                    <div className="left">
                                        <h2 className="poort-text poort-in-right">The Results of
                                            Our Project</h2>
                                    </div>
                                    <div className="right s2">
                                        ...
                                        <div className="item">
                                            <ul>
                                                <li>
                                                    <h3><i className="ti-check"></i>Support clients</h3>
                                                ...
                                                <li>
                                                    <h3><i className="ti-check"></i>Solve problems</h3>
                                                    <span>Sed ut perspiciatis unde omnis natus voluptatem
                                                        accusantium
                                                        doloremque laudantium, totam rem aperiam
                                                        inventore</span>
